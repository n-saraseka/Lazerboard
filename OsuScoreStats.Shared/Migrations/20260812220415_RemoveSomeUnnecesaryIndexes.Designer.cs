...
namespace OsuScoreStats.Shared.Migrations
{
    ...
    [Migration("20260812220415_RemoveSomeUnnecesaryIndexes")]
    partial class RemoveSomeUnnecesaryIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OsuScoreStats.Shared.DbService.Entities.Beatmap", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("OsuScoreStats.Shared.DbService.Entities.Beatmapset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("OsuScoreStats.Shared.DbService.Entities.Country", b =>
                {
            ...
            modelBuilder.Entity("OsuScoreStats.Shared.DbService.Entities.Score", b =>
                {
            ...
            modelBuilder.Entity("OsuScoreStats.Shared.DbService.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("OsuScoreStats.Shared.DbService.Entities.Beatmap", b =>
                {
                    b.HasOne("OsuScoreStats.Shared.DbService.Entities.Beatmapset", "Beatmapset")
                        .WithMany()
            ...
            modelBuilder.Entity("OsuScoreStats.Shared.DbService.Entities.Beatmapset", b =>
                {
                    b.HasOne("OsuScoreStats.Shared.DbService.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("OsuScoreStats.Shared.DbService.Entities.Score", b =>
                {
                    b.HasOne("OsuScoreStats.Shared.DbService.Entities.Beatmap", "Beatmap")
                        .WithMany()
            ...
            modelBuilder.Entity("OsuScoreStats.Shared.DbService.Entities.User", b =>
                {
                    b.HasOne("OsuScoreStats.Shared.DbService.Entities.Country", "Country")
                        .WithMany()
