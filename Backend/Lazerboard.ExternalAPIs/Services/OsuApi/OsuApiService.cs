...
public class OsuApiService
{
    ...
    public async Task<APIBeatmap[]> GetBeatmapsAsync(IList<int> ids, CancellationToken ct = default)
    {
        var count = ids.Count;
    ...
    public async Task<APIUser[]> GetUsersAsync(IList<int> ids, CancellationToken ct = default)
    {
        var count = ids.Count;
