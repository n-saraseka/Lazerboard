...
namespace OsuScoreStats.Migrations
{
    ...
    [Migration("20260906145032_AddPpBlacklist")]
    partial class AddPpBlacklist
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "blacklist_reason", new[] { "red_flag", "timed_out", "too_dense", "too_fast", "too_long", "too_short" });
            ...
            modelBuilder.Entity("Lazerboard.Data.Database.Entities.PpBlacklistBeatmap", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<BlacklistReason>("Reason")
                        .HasColumnType("blacklist_reason")
                        .HasColumnName("reason");

                    b.HasKey("Id")
                        .HasName("pk_pp_blacklist");

                    b.HasIndex("BeatmapId")
                        .IsUnique()
                        .HasDatabaseName("ix_pp_blacklist_beatmap_id");

                    b.ToTable("pp_blacklist", (string)null);
                });
            ...
            modelBuilder.Entity("Lazerboard.Data.Database.Entities.PpBlacklistBeatmap", b =>
                {
                    b.HasOne("Lazerboard.Data.Database.Entities.Beatmap", "Beatmap")
                        .WithOne()
                        .HasForeignKey("Lazerboard.Data.Database.Entities.PpBlacklistBeatmap", "BeatmapId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_pp_blacklist_beatmaps_beatmap_id");
